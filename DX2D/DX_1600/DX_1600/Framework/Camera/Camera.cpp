...
void Camera::PostRender()
{
	...
	ImGui::SliderFloat2("Camera Scale", (float*)&_scale, 0.1, 5);
...
void Camera::ShackeStart(float magnitude, float duration, float reduceDamping)
{
}
...
void Camera::FollowMode()
{
	...
	Vector2 lerp = LERP(_view->GetPos(), -targetPos, 0.7f);
